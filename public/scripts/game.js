...
(function () {
  ...
  Runner.prototype = {
    ...
    gameOver: async function () {
      ...
      console.log(
        this.distanceMeter.getActualDistance(Math.ceil(this.highestScore))
      );
      console.log(
      ...
      if (this.distanceRan > this.highestScore) {
        ...
        const newScore = this.distanceMeter.getActualDistance(
          Math.ceil(this.highestScore)
        );
